...
?></div>
    ...
    <div class="formulario">
        ...
        <label for="nome" class="form-label">Nome:</label>
            <input type="text" class="form-control" name="Nome" required value="<?php echo $CONTATO['nome']; ?>">

        <label for="endereco" class="form-label">Endereço:</label>
            <input type="text" class="form-control" name="Endereco" required value="<?php echo $CONTATO['endereco']; ?>"><br>

        <label for="telefone" class="form-label">Telefone:</label>
            <input type="text" class="form-control" name="Telefone" required onkeyup= "mascara(this)" value="<?php echo $CONTATO['telefone']; ?>"><br>
